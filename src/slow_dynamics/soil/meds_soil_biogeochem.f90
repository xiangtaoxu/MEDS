...
module meds_soil_biogeochem
   ...
   use meds_constants,        only : yr_day, tiny_num, kgCday_2_umols
...
contains
   ...
   !  functional form assemble_env_scalar's own moisture modifier uses, so xi and the fast Rh reconcile    !
