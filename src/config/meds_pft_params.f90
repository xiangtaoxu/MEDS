...
module meds_pft_params
   ...
   type :: pft_table_t
      ...
      !----- Leaf photosynthesis / stomatal traits (per PFT; see meds_fast_config). -------!
      ...
      !< [--] labile (vs structural) fraction of leaf/storage/fine-root necromass
      real(wp),    allocatable :: f_labile_leaf(:)
