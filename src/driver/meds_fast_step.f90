   ...
   subroutine column_fast_step(dt_fast, cfg, col_config, aenv, ageom, col_cohort, forc, biophys, aero, budget, gpp_coh, &
      ...
      if (cfg%time_integrator == INTEG_RK45) then
         ...
         block
            ...
            logical               :: rk45_stiff
            bio_save = biophys ; budg_save = budget
            call column_fast_step_rk45(dt_fast, cfg, col_config, aenv, ageom, col_cohort, forc, biophys, aero, budget, &
