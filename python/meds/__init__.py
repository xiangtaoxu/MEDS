...
submodule:
    ...
    meds.leaf        — leaf-level plant ecophysiology: photosynthesis + stomatal conductance, and the
                       leaf-phenology signal kernel in the submodule meds.leaf.pheno.
...
library lazily (meds.leaf / meds.leaf.pheno -> libmeds_plant_c, meds.demography -> libmeds_c) on
first import, so `import meds` works even without the shared libraries built.
"""
__version__ = "0.1.0"
