...
>
> **Shipped in PR #58** (2026-07-21). Each physical process has one implementation shared by both
> integrators: the canopy-air box, the ground surface fluxes, the diagnostic leaf/wood balance and
> heterotrophic respiration.
>
> **Both of its deferred follow-ups closed later:** the legacy canopy-air update kernels were retired
> in PR #59, and the prognostic-leaf `error stop` disappeared when the tissue store was reworked in
> PR #88. Its §6 appendix end-state — one integrator — arrived on 2026-07-31.
>
