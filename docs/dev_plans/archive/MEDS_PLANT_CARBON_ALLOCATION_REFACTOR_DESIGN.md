...
>
> **Shipped in PR #52** (2026-07-20), with the science page following in PR #55. The elemental
> allocation kernel, the priority ladder, growth respiration charged on realized growth, and the
> shed-first turnover all landed as designed.
>
> **Live description:** `docs/science/plant_carbon_allocation.md`. Module:
> `src/slow_dynamics/plant/meds_plant_carbon_allocation.f90`.
>
...
- `docs/science/plant_phenology.md` — **edit**: document `leaf_shed_rate = max(active, baseline)` floor
  + `fineroot_shed_rate`.
- `docs/dev_plans/archive/MEDS_PLANT_CARBON_DYNAMICS_DESIGN.md` — mark superseded.
