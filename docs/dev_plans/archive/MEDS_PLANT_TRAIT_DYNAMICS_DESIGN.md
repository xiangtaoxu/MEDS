...
> # 🗃️ ARCHIVED — 2026-09-13. Complete, with one deferred sibling.
>
> **Shipped in PR #54** (2026-07-20), science page in PR #55. Light-driven plasticity of specific
> leaf area, V_cmax, dark respiration and leaf lifespan is live. The driver entry point is
> `advance_plant_traits`, not the `advance_trait_dynamics` this document names.
>
> **§5 thermal acclimation was never built** and is tracked in `docs/ROADMAP.md` §7.
>
> **Live description:** `docs/science/plant_traits.md`. Module:
> `src/slow_dynamics/plant/meds_plant_trait_dynamics.f90`.
>
