...
> # 🗃️ ARCHIVED — 2026-09-13. Fully addressed.
>
> **Every section was resolved across PRs #29–#34** (2026-07-07/08), and PR #34 annotated this file
> in place with per-finding resolution status. The derived fix plan is
> `archive/MEDS_HIGH_PRIORITY_BUGFIX_PLAN.md`.
>
> Two of its deferred items outlived it and are now tracked elsewhere: S2 (shared surface-physics
> helpers) was done by PR #58, and S3 (the silent-omission hazard in the hand-written
> structure-of-arrays code) is the theme of `MEDS_CODE_STRUCTURE_DESIGN.md` §15.5 and issue #146.
>
> Every file path and line number below is the pre-2026-09 tree — this review predates two
> reorganizations.
