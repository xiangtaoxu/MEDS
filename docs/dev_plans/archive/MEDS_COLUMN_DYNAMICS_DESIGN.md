...
> # 🗃️ ARCHIVED — 2026-09-13. Three of its four parts shipped and live on under other names.
>
> **Implemented in PR #28** (2026-07-06), with the forcing join in PRs #35/#36 and the Picard
> coupling in PR #37.
>
> | This document | Where it lives now |
> |---|---|
> | Part I — canopy aerodynamics | `src/fast_dynamics/canopy/meds_canopy_aerodynamics.f90` |
> | Part II — the operator-split sweep | **retired** (PR #88); ARK is the default |
> | Part III — shared numerics | `src/util/meds_numerics.f90` |
> | Part IV — budget checks | `src/util/meds_budget_check.f90` |
>
> **Live description:** `docs/science/canopy_aerodynamics.md` and `column_biophysics.md`.
>
