...
> # 🗃️ ARCHIVED — 2026-09-13. Every fix in it shipped.
>
> **All seven real fixes merged in PR #29** (2026-07-07); the medium, low-priority, performance and
> organization tiers followed in PRs #30–#33, and PR #34 annotated the parent review. Bug 6 was
> refuted during the work and documented rather than fixed.
>
> **Bug 7's fix was later mooted:** it corrected Dunne saturation-excess runoff, and Dunne runoff was
> deleted outright in PR #88 when the aquifer became a pure boundary condition.
>
> **Parent document:** `archive/MEDS_CODE_REVIEW_2026-07-06.md`.
>
...
physical-process findings of the MEDS code review (`docs/dev_plans/archive/MEDS_CODE_REVIEW_2026-07-06.md`, §2.1).
...
- **Files:** `src/biophysics/meds_column_energy.f90`, `src/biogeochemistry/meds_column_co2.f90`,
  ...
  `test/test_column_co2.f90`, `docs/dev_plans/archive/MEDS_COLUMN_CO2_BALANCE_DESIGN.md`,
