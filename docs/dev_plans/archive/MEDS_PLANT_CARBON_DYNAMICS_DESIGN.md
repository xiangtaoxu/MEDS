...
> # 🗃️ ARCHIVED — 2026-09-13. Superseded; kept for historical context only.
>
> **Superseded on 2026-07-20** by `archive/MEDS_PLANT_CARBON_ALLOCATION_REFACTOR_DESIGN.md` and the
> science page `docs/science/plant_carbon_allocation.md`. Its own banner below says the same.
>
> Its kernels shipped in **PRs #14 and #15** (2026-07-04/05) and were then rewritten: the module was
> renamed `meds_plant_carbon_allocation`, made elemental over the cohort structure-of-arrays with no
> `carbon_*_t` structs, growth respiration moved inside the kernel, and tissue turnover moved into
> the phenology kernel as a baseline-floored shed rate. Reproduction became a carbon **flow** in
> PR #137.
>
